const MILESTONES = [
  {
    ...
    desc: 'NIF produced 1.35 MJ. For the first time, fusion self-heating exceeded external heating.',
    color: '#ffa726',
    tag: 'NIF',
  },
  {
    ...
    desc: 'NIF produced 3.15 MJ from 2.05 MJ of laser input. Q was 1.54. The most significant milestone in fusion history.',
    color: '#4caf50',
    tag: 'NIF · Historic',
    highlight: true,
  },
  {
    ...
    desc: 'NIF repeated ignition. The second shot reached 3.88 MJ. The result was real.',
    color: '#66bb6a',
    tag: 'NIF',
  },
  {
    ...
    date: 'Ongoing',
    title: 'ITER Assembly',
    desc: 'ITER assembly continues in Cadarache, France. The central solenoid and vacuum vessel sectors are in place.',
    color: '#29b6f6',
    tag: 'ITER',
  },
  {
  ...
  },
  {
    ...
    desc: 'ITER lights its first plasma. Thirty-five nations built this machine. Now it begins.',
    color: '#26c6da',
    tag: 'ITER',
  },
  {
    ...
    desc: 'SPARC targets Q greater than 2 in a compact reactor. Success clears the path to commercial fusion.',
    color: '#7e57c2',
    tag: 'SPARC',
  },
  {
    ...
    desc: 'ITER runs full deuterium-tritium fusion targeting Q of 10. That is 500 megawatts sustained for 400 seconds.',
    color: '#29b6f6',
    tag: 'ITER',
  },
  {
    ...
    desc: 'Multiple private companies and the DEMO program target grid-connected fusion electricity. The first commercial plants go online.',
    color: '#ef5350',
    tag: 'Commercial',
  },
]
